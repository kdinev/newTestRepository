...
export class TransformDataPipeChildView implements PipeTransform {
...
@Component({
  ...
  imports: [IGX_LIST_DIRECTIVES, IgxFinancialChartModule, IgxIconComponent, TransformDataPipeChildView],
